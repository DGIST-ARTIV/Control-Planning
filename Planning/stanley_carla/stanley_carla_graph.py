...
L = 2.875  # [m] Wheel base of vehicle
...
def execute(node_):
    ...
    gpsyawSub = node_.create_subscription(Float64, "/opencr/imu_yaw", gpsyawCallback, 0)
    ...
    ioniqSub = node_.create_subscription(Float32MultiArray, "/Carla_info", ioniqinfoCallback, 0)
