...
form_class = uic.loadUiType("pid_viewer_0707.ui")[0]
...
class ApplyThread(QThread):
    ...
    def pitchCallback(self, msg):
        myWindow.lineEdit_4.setText(str(msg.data))
        if msg.data > float(myWindow.lineEdit_16.text()):
            myWindow.label_21.setText("ascend")
        elif float(myWindow.lineEdit_16.text()) > msg.data and msg.data > float(myWindow.lineEdit_17.text()):
            myWindow.label_21.setText("even")
        elif msg.data < float(myWindow.lineEdit_17.text()):
            myWindow.label_21.setText("desecned")
    ...
    def run(self):
        ...
        imuPitchSub = self.node_.create_subscription(Float64,
            "/imu_pitch",
            self.pitchCallback)
